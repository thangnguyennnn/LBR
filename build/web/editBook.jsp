                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Sửa sách</h3>
                                    </div>
                                ...
                                <form role="form" method="post"
                                        ...
                                        <div class="form-group">
                                            <label>Thể loại</label> <select name="category" id="category"
                                                ...
                                                <c:forEach items="${listCate}" var="c">
                                                    <option ${c.id == b.cateID ? "selected":""} value="${c.id}">${c.name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Số lượng</label> <input type="number"
                                                                           class="form-control" id="count" name="count" min="1" value="${b.quantity}">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <input type="button" value="Trở lại" class="btn btn-primary"
                                               onclick="location.href = 'loadManagerBook'">
                                    </div>
                                </form>
                            </div>
